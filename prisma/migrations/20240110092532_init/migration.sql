...
-- CreateTable
CREATE TABLE "academic_semsters" (
    "id" TEXT NOT NULL,
    "year" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    ...
    CONSTRAINT "academic_semsters_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "students" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "academicSemsterId" TEXT NOT NULL,
    "academicFacultyId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "academic-departments" ADD CONSTRAINT "academic-departments_academicFacultyId_fkey" FOREIGN KEY ("academicFacultyId") REFERENCES "academic_faculty"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicSemsterId_fkey" FOREIGN KEY ("academicSemsterId") REFERENCES "academic_semsters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
