...
-- AddForeignKey
ALTER TABLE "student_enrolled_course_marks" ADD CONSTRAINT "student_enrolled_course_marks_academicSemeserId_fkey" FOREIGN KEY ("academicSemeserId") REFERENCES "academic_semsters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "student_semester_payments" ADD CONSTRAINT "student_semester_payments_academicSemeserId_fkey" FOREIGN KEY ("academicSemeserId") REFERENCES "academic_semsters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
