...
import { OfferedClassSchedulesUtils } from '../offeredCourseClassSchedule/offeredCourseClassSchedule.utils';
import {
...
const insertIntoDB = async (
  ...
  await asyncForEach(classSchedules, async (schedule: any) => {
    await OfferedClassSchedulesUtils.checkRoomAvailable(schedule);
    await OfferedClassSchedulesUtils.checkFacultyAvailable(schedule);
  });
